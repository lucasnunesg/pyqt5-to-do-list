...
from PyQt5.QtWidgets import QMainWindow, QApplication, QLabel, QPushButton, QListWidget, QLineEdit, QMessageBox, QGridLayout, QWidget
...
def change_window(current, next):
    UIWindow = UI()
    current.close()
    next.open()
class LoginForm(QWidget):
    ...
    def check_password(self):
        ...
        if self.lineEdit_username.text() == "Lucas" and self.lineEdit_password.text() == "123456":
